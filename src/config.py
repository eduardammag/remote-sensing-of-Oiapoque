...
OUTPUT_FILE = os.path.join(OUTDIR, "dados_classificados.csv")
OUTPUT_RELATORIO = os.path.join(OUTDIR, "relatorio.csv")
...
CLASSES_CSV = r"\input\tipologia_classificada.csv"
